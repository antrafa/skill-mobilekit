...
- [`../prompts/RULES.md`](../../prompts/RULES.md) — the rules every prompt inherits. Short, and worth reading yourself once. [`../prompts/README.md`](../../prompts/README.md) lists all 51 prompts and the reference order the plan cuts down from.
