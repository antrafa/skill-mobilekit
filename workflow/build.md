...
Match the argument against the prompt index in `SKILL.md` and `prompts/README.md`. A filename matches directly; a word matches by subject — "auth", "analytics", "offline", "deploy", "permissions", "media", "legacy".
