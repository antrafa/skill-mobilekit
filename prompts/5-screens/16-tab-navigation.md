...
- Animated transition for B, using the installed animation library (see `11-reanimated-animations.md`) and honoring reduced-motion
...
- [ ] Home screen UI not built here — that is `17-home-screen.md`
