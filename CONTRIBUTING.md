...
`prompts/RULES.md` changes the behaviour of all 57 prompts at once. Say in the commit body which failure the change prevents, and check that no prompt now contradicts it.
